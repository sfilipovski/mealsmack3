...
public class RestaurantRepository {
    ...
    public List<Restaurant> filterRestaurants(String name, String amenity, String cuisine){
       ...
       /* if(name.equals("all") && !amenity.equals("all")){
            return restaurants.stream().filter(r -> r.getAmenity().equals(amenity)).collect(Collectors.toList());
        }
        else if(!name.equals("all") && amenity.equals("all"))
            return restaurants.stream().filter(r -> r.getMunicipality().equals(name)).collect(Collectors.toList());
        else if(!name.equals("all") && !amenity.equals("all")){
            return restaurants.stream().filter(r -> r.getMunicipality().equals(name) && r.getAmenity().equals(amenity)).collect(Collectors.toList());
        }*/
        return restaurants;
    }
